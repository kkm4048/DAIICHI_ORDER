...
namespace DAIICHI_ORDER
{
    class cls_com
    {
        public static string g시스템명 = "DAICHI_ORDER";
        public static string g상호 = "다이치";

        public static string sql;

        public static string gConn_String = "Data Source=211.53.243.202,1433;Initial Catalog=DAIICHI_ORDER;User Id=daiichi_order;Password=ekdlcl4324!@#";
        ...
        public static string 숫자만(string 값)
        {
            ...
            {
                if ( "0123456789".IndexOf(값.Substring(i, 1).ToString()) >= 0  ) 
                {
                    d = d + 값.Substring(i, 1);
                }
            }
        ...
        public static bool 한글여부(string d)
        {
            char[] achar = d.ToCharArray();
