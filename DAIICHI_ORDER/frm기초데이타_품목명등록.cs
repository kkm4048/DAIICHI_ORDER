...
{
    public partial class frm기초데이타_품목명등록 : Form
    {

        string sql = "";
        public frm기초데이타_품목명등록()
        {
            InitializeComponent();
        }
        ...
        private void frm기초데이타_품목명등록_Load(object sender, EventArgs e)
        {
        ...
        private void 조회()
        {
            ...
            sql = " exec s_a101_품목명_조회 '1','" + txt조회.Text + "' ";
